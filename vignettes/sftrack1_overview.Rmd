...
head(my_sftraj)
plot(my_sftraj, axes = TRUE)

```

In the next vignettes we will go into more detail of sftrack objects, how to create them, an in-depth description of working with groupings, and how to plot with sftrack using base and ggplot.
