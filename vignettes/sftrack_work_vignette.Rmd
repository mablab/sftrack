...
```{r}
# sftrack
my_sftrack <- as_sftrack(data = raccoon_data, burst = burst, active_burst = active_burst, error = error, time = time , coords = coords ,crs = crs)
my_sftrack


# sftraj
my_sftraj <- as_sftraj(data = raccoon_data, burst = burst, active_burst = active_burst, error = error, time = time , coords = coords, crs = crs )
my_sftraj
