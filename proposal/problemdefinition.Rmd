...
While the collection of tracking data <<<, In parallel, the use of R
for movement studies has also greatly increased, in contrast to the
decline of most other platforms—for instance, in the field of Movement
Ecology, we count more than 70 % of studies using R in 2018,
