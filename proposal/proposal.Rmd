...
$(x, y [, z], t)$, which define a track made of sequential steps, i.e. the
...
representation of steps forming a track. The implementation aims at
...
The implementation is complicated by the fact that a full
...
nesting
for example journeys, which we define as connections between two relevant locations
related to an individual or a household, for example the movement from home to work and
from work to shopping (Biljecki *et al.* 2013)
