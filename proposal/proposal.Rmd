...
objects (Turchin 1998). In practice, this curve is sampled (recorded)
at discrete times with 4D vertices of coordinates (3-dimensional
spatial coordinates and temporal coordinate), which define tracking
data of the form $(x, y, z, t)$.
