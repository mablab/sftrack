...
the object turns (Fig. 1). Moves can be of varying length and
associated time span, depending on the nature of the
movement. Treating moves as straight lines is an "idealization", but
at sufficient resolution, no significant information is lost.
...
```{r data-model, echo = FALSE, out.width = "80%", fig.cap = "Proposed conceptual model.", fig.align = "center"}
